...
class PublicUserApiTests(TestCase):
    ...
    def test_user_exists(self):
        ...
        payload = {'email':'test21@gmail.com','password':'123456'}
        create_user(**payload)
    ...
    def test_password_too_short(self):
        ...
        payload = {'email':'test21@gmail.com','password':'pw'}
        res = self.client.post(CREATE_USER_URL, payload)
    ...
    def test_create_token_invalid_credentials(self):
        ...
        create_user(email='test@gmail.com',password='123465')
    ...
    def test_craete_token_no_user(self):
        ...
        payload= {'email':'test@gmail.com','password':'123465'}
...
class PrtivateUserApiTests(TestCase):
